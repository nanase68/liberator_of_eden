...
echo('<img src="'. $rank_ary[0]['MUTTER_IMG']) . '"'; ?>
					<p class="uploader">投稿者: <a href="#"><?php echo $rank_ary[0]['USER_']; ?></a></p>
				</div>
<?php } ?>
...
?>
				<div class="micro_content">
					...
					<p class="uploader">投稿者： <a href= <?php echo "my_page.php?id=" . $mutter['USER_ID']; ?> > <?php echo $mutter['USER_NAME'];?></a></p>
				</div>
<?php } ?>
...
?>
				<div class="micro_content">
					...
					<p class="uploader">投稿者： <a href= <?php echo "my_page.php?id=" . $mutter['USER_ID']; ?> ><?php echo $rank_ary[$i]['USER_NAME'] ?> </a></p>
				</div>
<?php } ?>
